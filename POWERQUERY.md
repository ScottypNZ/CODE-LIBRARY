...
### COUNTIFS
```
#STEP 1 - GROUP BY PRIMARY FILED "ISSUE"#
GROUP BY [SHORT NAME REFERENCE] | Count | ALL ROWS

#STEP 2 - ADD COLUMN [FILTER], SECOND VARIABLE = FILTER. IN THIS CASE 1#
=Table.SelectRows([Count], each ([OCC] = 1))
...
###### D | ADD COUNT OF FIRST OCCURANCES, THIS IS TO ENSURE THAT WHERE THERE WILL ONLY BE ONE PARTY IN THE GROUP REMAIING THE WHOLE GROUP REMAINS
