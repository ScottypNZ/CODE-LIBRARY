...
<!-- QUESTION 1, DATE OF EVALUATION --> 
          ...
          <p>Date of Evaluation</p>
          <input type="date" name="bdate" />
          <i class="fas fa-calendar-alt"></i>
        </div>
        <div class="item">

<!-- QUESTION 2, TIME OF EVALUATION --> 
...
<!-- QUESTION 3, WHERE ARE YOU CURRENTLY LIVING--> 
...
<!-- QUESTION 4, Why are you needing help? --> 

        <p>Why are you needing help? </p>
        <textarea rows="3">
*Type here*
        </textarea >
        </div>
...
<!-- QUESTION 5, How long have you been in your current accommodation? --> 
...
<!-- QUESTION 6, If we could provide some support could you stay where you are? --> 
